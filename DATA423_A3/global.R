...
glmnet_initial <- c("impute_bag", "center", "scale", "dummy") 
pls_initial <- c("impute_knn", "center", "scale", "dummy")   
rpart_initial <- c("center", "scale", "dummy") 

# maintenance point ---------------------------------------------------------------------------------------------------------------------------
# add further preprocessing choices for the new methods here

nnet_initial = c("impute_bag", "center", "scale", "dummy")
bagEarth_initial = c("impute_knn", "center", "scale", "dummy")
qrf_initial = c("impute_knn", "center", "scale", "dummy")
glm_initial = c("impute_knn", "center", "scale", "dummy")
bayesglm_initial = c("impute_knn", "center", "scale", "dummy")
leapSeq_initial = c("impute_knn", "center", "scale", "dummy")
avNNet_initial = c("impute_knn", "center", "scale", "dummy")
cubist_initial <- c("impute_bag", "center", "scale", "dummy") 
knn_initial <- c("impute_knn", "center", "scale", "dummy") 
spikeslab_initial <- c("impute_knn", "center", "scale", "dummy")
...
ppchoices <- c("impute_knn", "impute_bag", "impute_median", "impute_mode", "YeoJohnson", "naomit", "pca", "pls", "ica", "center", "scale", "month", "dow", "dateDecimal", "nzv", "zv","other", "dummy","poly", "interact", "indicate_na")
